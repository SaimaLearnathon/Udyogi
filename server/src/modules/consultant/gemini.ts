...
- থিসিস ড্রাফট তৈরি হওয়ার পর, ব্যবহারকারী যদি স্পষ্টভাবে বলে যে সে থিসিসটি নিশ্চিত/চূড়ান্ত/কনফার্ম করতে চায় (টেক্সটে যেভাবেই বলুক না কেন), তাহলে ${CONFIRM_THESIS_FUNCTION} ফাংশন কল করে সেটি নিশ্চিত করে দাও। এরপর ব্যবহারকারীকে সংক্ষেপে জানাও যে থিসিসটি নিশ্চিত করা হয়েছে।
`;
